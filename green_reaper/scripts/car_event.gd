...
func select_option(option_num: int) -> void:
	if option_num == 1:
		event_body = "You pull out your keys and start scratching his car. Someone in the backseat gets out of the car. They beat you up and take $%d from your wallet. What were you thinking?" % _random_stake
